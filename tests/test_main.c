...
extern void test_json_parser_openai_valid(void);
extern void test_json_parser_gemini_valid(void);
extern void test_json_parser_mistral_valid(void);
extern void test_json_parser_empty_response(void);
extern void test_json_parser_api_error(void);
extern void test_json_parser_missing_total_tokens(void);
extern void test_json_parser_malformed_json(void);
extern void test_json_parser_build_openai_request(void);
extern void test_json_parser_build_messages_array(void);
...
int main(void) {
    ...
    RUN_TEST(test_json_parser_openai_valid);
    RUN_TEST(test_json_parser_gemini_valid);
    RUN_TEST(test_json_parser_mistral_valid);
    RUN_TEST(test_json_parser_empty_response);
    RUN_TEST(test_json_parser_api_error);
    RUN_TEST(test_json_parser_missing_total_tokens);
    RUN_TEST(test_json_parser_malformed_json);
    RUN_TEST(test_json_parser_build_openai_request);
    RUN_TEST(test_json_parser_build_messages_array);
