...
Le binaire supporte maintenant une inscription depuis le terminal sans passer par le frontend.

```bash
./build/bin/smartstudy --register --email user@example.com --username user --password secret123
```

Si un champ manque, le programme le demande de manière interactive avant de créer le compte.
